...
class TestReplaceSemantics:
    ...
    def test_stock_loaded_not_emitted_by_auto_populate(self, qtbot):
        ...
        assert stock_loaded_calls == [], (
            "stock_loaded must not be emitted by auto_populate_stock"
        )
...
class TestMaterialScoping:
    ...
    def test_material_scoping(self, qtbot):
        ...
        assert materials == {"S355JR"}, (
            f"Expected only S355JR; got {materials}"
        )
...
class TestOverlengthSeeding:
    ...
    def test_overlength_seeding(self, qtbot):
        ...
        assert any(l >= 17000.0 for l in lengths), (
    ...
    def test_no_overlength_bar_when_standard_covers_piece(self, qtbot):
        ...
        assert extra_bars == [], (
            f"Unexpected over-length bars for a 3000mm piece: {extra_bars}"
        )
