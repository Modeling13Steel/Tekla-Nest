...
def _three_parts() -> list[PartEntry]:
    return [
        ...
        PartEntry(quantity=2, length=4000, reference="B",
                  profile="HEA240", material="S275JR"),
        PartEntry(quantity=3, length=5000, reference="C",
                  profile="IPE200", material="S355JR"),
    ]
...
def test_delete_keyboard_shortcut(qtbot):
    ...
    table = widget._table
    shortcuts = [
        sc for sc in table.findChildren(QShortcut)
