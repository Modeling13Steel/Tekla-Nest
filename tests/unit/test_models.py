...
class TestPartEntry:
    def test_create(self):
        pe = PartEntry(quantity=5, length=2500.0, reference="C3", profile="HEA240", material="S275JR")
...
class TestStockEntry:
    ...
    def test_create_with_explicit_source(self):
        se = StockEntry(quantity=5, length=10100.0, priority=-1000, profile="IPE200", material="S355", source="Cliente")
